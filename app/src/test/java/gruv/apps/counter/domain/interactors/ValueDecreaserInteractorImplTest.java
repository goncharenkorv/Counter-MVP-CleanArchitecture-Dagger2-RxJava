...
public class ValueDecreaserInteractorImplTest {
    ...
    private ValueDecreaserInteractorImpl mInteractor;
    ...
    public void setUp() throws Exception {
        ...
        mInteractor = new ValueDecreaserInteractorImpl(testScheduler, testScheduler);
    ...
    public void runTest() {
        ...
        Mockito.verify(mCallbacksImpl).vibrate(VIBRATION_DECREASE_DURATION);
        Mockito.verify(mCallbacksImpl).playSound(Constants.Sound.DECREMENT_SOUND);
    }
